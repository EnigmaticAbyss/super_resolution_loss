...
parser = argparse.ArgumentParser(description="Run train of super-resolution training with dynamic configuration")
parser.add_argument("--trainer", type=str, required=True, help="Path to the config file to train")
args = parser.parse_args()

# Load configuration from the specified file
with open(args.trainer) as file:
...
# fit(model, train_loader, valid_loader, optimizer, scheduler, loss_fn, writer, config, early_stop_num=10)